...
(function() {
        ...
        function b(b) {
            ...
            if (c.config.autoParagraph !== false && i != CKEDITOR.ENTER_BR && g.collapsed && d.equals(f) && !e.block) {
                ...
                if (!e.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) {
                    ...
                    if (CKEDITOR.env.ie)(c = c.getFirst(a)) && (c.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(c.getText()).match(/^(?:&nbsp;| )$/)) && c.remove();
                    g.select();
                    b.cancel()
                }
            }
                ...
                if (!D.checkReadOnly()) {
                    ...
                    if (u) {
                        ...
                        if (s.type == "text" && s.inlineStylesRoot) {
                            ...
                            z = r.getOuterHtml().replace("{cke-peak}", w)
                        }
    ...
    (function() {
        ...
        function W(a) {
            ...
            } else f.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? (B(a), i && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom < d.pane.height ? j = x : 0 < b.y && b.y < f.size.top + e && (j = w)) : j = r, c = [null, f][i ? "reverse" : "concat"]().concat([i ? V : C, F, j, f.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? i ? x : w : r]);
        ...
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function(d) {
                ...
                d.ui.addRichCombo("Styles", {
                    ...
                    onOpen: function() {
                        var a = d.getSelection().getSelectedElement(),
                            a = d.elementPath(a),
                            c = [0, 0, 0, 0];
                        this.showAll();
                        this.unmarkAll();
